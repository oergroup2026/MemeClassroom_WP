        ...
        <div className="relative max-w-7xl mx-auto px-3 sm:px-6 h-14 sm:h-16 flex items-center justify-between">
          ...
          <div className="flex items-center z-10">
            {searchExpanded ? (
              ...
              <button
                ...
                className={`flex items-center justify-center p-2 sm:p-2.5 rounded-xl transition duration-200 border shadow-xs group ${
                  highContrastMode
          ...
          <div className={`absolute left-1/2 -translate-x-1/2 flex items-center justify-center gap-0.5 sm:gap-1.5 md:gap-2 transition-all duration-200 ${searchExpanded ? 'hidden sm:flex opacity-40 md:opacity-100 pointer-events-none md:pointer-events-auto' : 'flex'}`}>
            {bottomNavItems.map((item) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  `relative flex flex-col sm:flex-row items-center justify-center gap-0.5 sm:gap-1.5 px-2.5 sm:px-3.5 py-1 sm:py-1.5 rounded-xl text-[10px] sm:text-xs transition-all duration-200 group ${
                    isActive
                  ...
                  <>
                    <item.Icon
                      className={`w-4 h-4 sm:w-4.5 sm:h-4.5 transition-transform duration-200 group-hover:scale-110 ${
                        isActive ? "text-ruby-600 dark:text-ruby-400" : ""
                      }`}
          ...
          <div className="flex items-center justify-end z-10">
            <button
              ...
              className={`flex items-center justify-center p-2 sm:p-2.5 rounded-xl transition-all duration-200 border shadow-xs ${
                a11yMenuOpen
